...
const PostCard = React.memo(
  ({
    ...
    const isOwner = useMemo(() => {
      return !!user?.id && !!item?.author?.id && item.author.id === user.id;
    }, [user, item.author]);
    ...
    return (
      ...
      >
        {/* Repost Indicator - FIXED Null Check */}
        ...
        <View className="flex-row">
          ...
          >
            <View
              className={`shadow-lg`}
              style={{ shadowColor: accentColor, shadowOpacity: 0.1 }}
            >
              <Image
                source={{
                  uri:
          ...
          <View className="flex-1">
            ...
            <View className="mb-1">
              {displayPost.parentPost && !isRepostAction && (
                ...
                >
                  <Text
                    className={`text-[11px] font-black uppercase tracking-tight ${isDark ? "text-slate-400" : "text-sky-600"}`}
                  >
                    Replying to{" "}
            ...
            {/* Quote Post Preview - Added Safe Chaining */}
            ...
            <View className="flex-row justify-between items-center mt-3 pr-2">
              <ActionButton
                ...
                onPress={() => displayId && onPressComment(displayId)}
              />
              <ActionButton
                icon="repeat"
              ...
              <ActionButton
                ...
                onPress={() => displayId && onBookmark(displayId)}
              />
            </View>
          </View>
        </View>
...
//                 }}
//                 className={`w-23 h-23 rounded-[22px] ${isDark ? "bg-slate-800 border-slate-700" : "bg-gray-50 border-gray-100"} border`}
//                 contentFit="cover"
//                 transition={400}
