  ...
  return (
    <View className="flex-1 bg-[#F8FAFC] dark:bg-[#0F172A]">
      ...
      <BlurView intensity={80} tint="default" className="flex-row items-center px-5 py-4 border-b border-gray-100/50 dark:border-slate-800/50" style={{ paddingTop: insets.top }}>
        ...
        <Text className="text-xl font-black ml-4 text-gray-900 dark:text-white tracking-tighter uppercase">Followers</Text>
      </BlurView>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View className="items-center py-20 px-10">
              ...
              <Text className="text-xl font-black text-gray-900 dark:text-white tracking-tight text-center uppercase">Solitary Spirit</Text>
              <Text className="text-gray-400 dark:text-slate-500 text-center mt-2 font-medium">No one has joined this sanctuary yet.</Text>
            </View>
          }
        />
      )}
