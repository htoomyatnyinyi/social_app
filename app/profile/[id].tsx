...
export default function UserProfileScreen() {
  ...
  const currentData = useMemo(() => {
    ...
    if (activeTab === "replies") {
      // In some APIs, the "replies" endpoint already filters, but we double-check 
      // to ensure only conversational items show here.
...
//   const currentData = useMemo(() => {
//     if (activeTab === "posts") {
//       return (postData?.posts || []).filter((post: Post) => !post.parentPost);
//     }
//     if (activeTab === "likes") return likeData?.posts || [];
//     if (activeTab === "replies") {
//       return (replyData?.posts || []).filter((post: Post) => !!post.parentPost);
//     }
//     return [];
//   }, [activeTab, postData, likeData, replyData]);
