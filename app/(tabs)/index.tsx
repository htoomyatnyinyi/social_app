...
//     const hasReposted = useMemo(() => {
//       return (
//         displayItem?.repostedBy?.some((r) => r.userId === user?.id) || false
//       );
//     }, [displayItem?.repostedBy, user?.id]);
...
//               <TouchableOpacity
//                 className="flex-row items-center"
//                 onPress={() => displayId && onLike(displayId)}
//               >
//                 <Ionicons
//                   name={hasLiked ? "heart" : "heart-outline"}
//                   size={19}
...
//       // Corrected logic: Check the array for existing repost
//       const isAlreadyReposted = displayItem.repostedBy?.some(
...
//           >
//             <Text
//               className={`font-bold ${activeTab === tab ? "text-black" : "text-gray-500"}`}
//             >
//               {tab === "public" ? "For you" : "Following"}
//             </Text>
//             {activeTab === tab && (
...
//         onEndReachedThreshold={0.5}
//         ListFooterComponent={
//           isFetching && cursor ? <ActivityIndicator className="py-4" /> : null
//         }
//       />
...
//             </TouchableOpacity>
//             <TouchableOpacity className="bg-[#1d9bf0] px-4 py-1 rounded-full">
//               <Text className="text-white font-bold">Reply</Text>
//             </TouchableOpacity>
//           </View>
//           <TextInput
