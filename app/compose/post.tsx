...
import { useRouter, useLocalSearchParams } from "expo-router"; // Fixed import
...
export default function ComposePostScreen() {
  ...
  // Image & Location handlers (same as before, slightly cleaned)
  ...
  return (
    <View style={{ flex: 1, backgroundColor: isDark ? "#0A0F1C" : "#F8FAFC" }}>
      {/* Modern Header */}
      <BlurView
        intensity={95}
      ...
      >
        <ScrollView
          ...
          style={{ flex: 1 }}
        >
          <View style={{ padding: 20, flexDirection: "row", gap: 14 }}>
            {/* Larger Avatar */}
            <Image
              source={{
                uri:
              ...
              style={{ width: 52, height: 52, borderRadius: 9999 }}
            />
            ...
            <View style={{ flex: 1 }}>
              {replyToName && (
                <View
                  style={{
                    backgroundColor: isDark ? "#1E40AF30" : "#DBEAFE",
              ...
              {locationTag && (
                <View
                  style={{
                    flexDirection: "row",
                    alignItems: "center",
                    backgroundColor: isDark ? "#052E1620" : "#ECFDF5",
                    paddingHorizontal: 14,
                    paddingVertical: 8,
                    borderRadius: 9999,
                    alignSelf: "flex-start",
        ...
        >
            ...
            <View style={{ flexDirection: "row", gap: 12 }}>
              ...
              >
                <Ionicons
                  ...
                  size={26}
                  color={locationTag ? "#10B981" : "#38BDF8"}
                />
              </TouchableOpacity>
            </View>
          ...
          {!isKeyboardOpen && <View style={{ height: insets.bottom }} />}
        </BlurView>
      </KeyboardAvoidingView>
