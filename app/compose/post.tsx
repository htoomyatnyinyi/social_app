...
export default function ComposePostScreen() {
  ...
  return (
    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      {/* 2. KeyboardAvoidingView wraps both the ScrollView and the Toolbar */}
      <KeyboardAvoidingView
        behavior={Platform.OS === "ios" ? "padding" : undefined}
        // keyboardVerticalOffset is crucial on iOS to account for the header height
      ...
      >
        ...
        >
          <View className="flex-row">
            ...
            <View className="flex-1 pb-10">
              ...
              {/* Quote & Image Previews remain here */}
              {image && (
                <View className="relative mb-4">
                  <Image
                    source={{ uri: image }}
        ...
        {/* 3. Toolbar is now INSIDE KeyboardAvoidingView, AFTER the ScrollView */}
        <View className="border-t border-gray-100 p-3 flex-row items-center bg-white">
          <TouchableOpacity onPress={pickImage} className="p-2 mr-4">
            <Ionicons name="image-outline" size={24} color="#1d9bf0" />
          </TouchableOpacity>
